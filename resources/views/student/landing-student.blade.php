		   ...
		   success:function(result_data)
			   {
					...
					$('#view_activity_title').html(activity_master[0].activity_title + '<span> ' + act_pbsh_grades.join(", ") + '</span>');
            ...
            <div class="container" style="position:relative;">
                ...
                <div class="row pb-5">
                    <div class="col-9 d-flex">
                        ...
                        <div>
                            <h3 class="font-weight-bold main-fo">{{$user_name  }}</h3>
                            <p class="sub-text">Grade: {{$student_grade}} </p>
                        </div>
						<h2  style="color: #fe6711;font-size:15px;white-space: nowrap;max-width: 450px;overflow: hidden;text-overflow: clip;" class="ml-auto mentor-quote">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <p class="sub-text2" style="font-size:13px;">{{$students_approved_activity->first_name . ' ' . $students_approved_activity->last_name}}</p>
                                            </td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <p class="sub-text2" style="font-size:13px;">By {{$students_approved_activity_completed->first_name . ' ' . $students_approved_activity_completed->last_name}}</p>
                                            </td>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <p class="sub-text2" style="font-size:13px;">By {{$students_approved_activity_not_completed->act_created_by_first_name . ' ' . $students_approved_activity_not_completed->act_created_by_last_name}}</p>
                                            </td>

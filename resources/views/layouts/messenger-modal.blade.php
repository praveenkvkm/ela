<style>
#modal-messenger .tab-pane 
{
  max-height:450px;
  overflow-y: hidden;
}

#modal-messenger .tab-pane::-webkit-scrollbar 
{
    width: 5px;
	background: #bbb5b5;
}

#modal-messenger .inbox_chat::-webkit-scrollbar 
{
    width: 5px;
	background: #bbb5b5;
}

#modal-messenger .tab-pane::-webkit-scrollbar-thumb 
{
    border-radius: 10px;
    background: #c3b5b5;
}

#modal-messenger .inbox_chat::-webkit-scrollbar-thumb 
{
    border-radius: 10px;
    background: #c3b5b5;
}

#modal-messenger .container{max-width:1170px; margin:auto;}
/*img{ max-width:100%;}*/
#modal-messenger .chat_img > img 
{
	max-width:100%;
}
#modal-messenger .incoming_msg{
    margin-left:15px;
}
#modal-messenger .incoming_msg_img > img 
{
	max-width:100%;
}
#modal-messenger .inbox_people {
  background: #f8f8f8 none repeat scroll 0 0;
  float: left;
  overflow: hidden;
  width: 40%; border-right:1px solid #c4c4c4;
}
#modal-messenger .inbox_msg {
  border: 1px solid #c4c4c4;
  clear: both;
  overflow: hidden;
}
#modal-messenger .top_spac{ margin: 20px 0 0;}


#modal-messenger .recent_heading {float: left; width:40%;}
#modal-messenger .srch_bar {
  display: inline-block;
  text-align: right;
  width: 60%; padding:
}
#modal-messenger .headind_srch{ padding:10px 29px 10px 20px; overflow:hidden; border-bottom:1px solid #c4c4c4;}

#modal-messenger .recent_heading h4 {
  color: #05728f;
  font-size: 21px;
  margin: auto;
}
#modal-messenger .srch_bar input{ border:1px solid #cdcdcd; border-width:0 0 1px 0; width:80%; padding:2px 0 4px 6px; background:none;}
#modal-messenger .srch_bar .input-group-addon button {
...
#modal-messenger .srch_bar .input-group-addon { margin: 0 0 0 -27px;}

#modal-messenger .chat_ib h5{ font-size:15px; color:#464646; margin:0 0 8px 0;}
#modal-messenger .chat_ib h5 span{ font-size:13px; float:right;}
#modal-messenger .chat_ib p{ font-size:14px; color:#989898; margin:auto}
#modal-messenger .chat_img {
  float: left;
  width: 11%;
}
#modal-messenger .chat_ib {
  float: left;
  padding: 0 0 0 15px;
  width: 88%;
}

#modal-messenger .chat_people{ overflow:hidden; clear:both;}
#modal-messenger .chat_list {
  border-bottom: 1px solid #c4c4c4;
  margin: 0;
  padding: 18px 16px 10px;
}
#modal-messenger .inbox_chat { height: 550px; overflow-y: scroll;}

#modal-messenger .active_chat{ background:#ebebeb;}

#modal-messenger .incoming_msg_img {
  display: inline-block;
  width: 6%;
}
#modal-messenger .received_msg {
  display: inline-block;
  padding: 0 0 0 10px;
  vertical-align: top;
  width: 92%;
 }
 #modal-messenger .received_withd_msg p {
...
#modal-messenger .time_date {
  color: #747474;
  display: block;
  font-size: 12px;
  margin: 8px 0 0;
}
#modal-messenger .received_withd_msg { width: 57%;}
#modal-messenger .mesgs {
  float: left;
  padding: 0px;
  width: 100%;
...
#modal-messenger .outgoing_msg{ overflow:hidden; margin:26px 15px 26px;}
#modal-messenger .sent_msg {
  float: right;
  width: 46%;
}
#modal-messenger .input_msg_write input {
  background: rgba(0, 0, 0, 0) none repeat scroll 0 0;
  border: medium none;
  color: #4c4c4c;
  font-size: 15px;
...
#modal-messenger .input_msg_write input:focus{
    outline:none;
}

#modal-messenger .type_msg {border-top:1px solid #e4e4e4;position: relative;}
#modal-messenger .msg_send_btn {
...
#modal-messenger .msg_send_btn:focus{
    outline:none;
}
#modal-messenger .messaging { padding: 0 0 50px 0;}
#modal-messenger .msg_history {
  height: 516px;
  overflow-y: auto;
  background: #fff;
}
...
#modal-messenger .modal-content .modal-body .nav-tabs li a{
    font-weight:700;
}

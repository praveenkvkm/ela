...
$(document).ready(function() {
	...
	function insert_stud_grade()
	{

		var url_var =  APP_URL + '/insert_stud_grade';
		
		var data = {};
		data['stud_grade'] = $('#stud_grade').val();
...
#item-stud-grade i, #item-stud-grade p
{
    color: #28a745!important;
}
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<label for="email2">Grade Name</label>
													<input  type="text" class="form-control" id="stud_grade" value="">
												</div>

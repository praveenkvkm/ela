            ...
            <div class="container">
                <div class="row pb-0">
                    <div class="col-12 d-flex">
                        ...
                        <div class="col-md-5">
                            <h3 class="font-weight-bold main-fo orange">French for Beginners</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="video-wrap">
                                        <video width="100%" controls poster="{{asset('public/ela-assets/images/vid.jpg')}}">
                                            <source src="{{asset('public/ela-assets/images/mov_bbb.mp4')}}" type="video/mp4">
                                            <source src="{{asset('public/ela-assets/mov_bbb.ogg')}}" type="video/ogg">
                                        </video>
                                    </div>
                                    <h3 class="pt-30">

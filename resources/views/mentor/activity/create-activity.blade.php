...
$(document).ready(function() {
	...
	$(document).on('click', '#btn-save-criteria', function(event)
	{
		valid = 1;
		...
		if(valid == 1)
		{
			if(confirm('Are you sure to Save this Criteria ?'))
			{
				
				
					var CSRF_TOKEN = '{{csrf_token()}}';
			 
					var url_var =  APP_URL + '/insert_ev_criterias';
					...
					{
						criteria[index] = $('#criteria-'+(index)).val();
						mark[index] = $(this).val();
					});		
					...
					$.ajax({
					   type:'post',
					   url: url_var,  
					   data: {data, criteria, mark},
					   async:false,
					   success:function(result_data)
						   {
								 //update_mentor_room_evaluation_statuses();
							  	criteria_updated = 1;
								$('#set-criteria-modal').modal('toggle');
							}
						});
...
*/					
	...
	{	
		...
		generate_room(); // if no allocations were done, this will generate a room and its id will be returned.
	...
	function generate_room()
	{
		...
		var url_var =  APP_URL + '/make_or_select_room';
	...
	$(document).on('change', '.check-grade', function(event)
	{
		...
		stud_grade_id = $(this).attr('id');
		
			
		var CSRF_TOKEN = '{{csrf_token()}}';
 
		var url_var =  APP_URL + '/allocate_grade_in_activity';
	...
	function show_invite_students_pane()
		{
		
			$(".tab-pane-media").removeClass("show");
			$(".tab-pane-media").removeClass("active");
			$("#invite-stud").addClass("show");
			$("#invite-stud").addClass("active");
			$(".nav-link-media").removeClass("active");
			$("#invite-stud-tab").addClass("active");
...
-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-9 d-flex">
						...
						?>
                            <h3 class="font-weight-bold main-fo"><a style="color:black" href="{{url('/mentor/dashboard')}}"> {{ $user_name }}</a> / Create New Activity</h3>
                            ...
                            <div class="col-md-3">
                                <div class="left-ul-wrap">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link  nav-link-media " id="invite-stud-tab" ><span>3.</span>Invite Students</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link  nav-link-media" id="send-tab"><span>4.</span> Send for Approval</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="tab-content" id="myTabContent"> 
                                    ...
                                    <div class="tab-pane tab-pane-media fade " id="invite-stud" role="tabpanel" aria-labelledby="contact-tab">
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="pills-grade-tab" data-toggle="pill" href="#pills-grade" role="tab" aria-controls="pills-profile" aria-selected="false">Grade</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content pl-0 pr-0 pt-0 pb-0" id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="pills-grade" role="tabpanel" aria-labelledby="pills-profile-tab">
                                                ...
                                                <div class="row students-lists">
                                                    ...
                                                    <div class="col-md-12 single-student">
                                                        ...
                                                        <div class="form-check">
                                                            <label class="form-check-label">
                                                                <input type="checkbox" class="form-check-input check-grade" value="" id="{{$stud_grade->id}}">
                                                            </label>
                                                        </div>
                                                    </div>
													@endforeach
                                    ...
                                    <div class="tab-pane tab-pane-media " id="send" role="tabpanel" aria-labelledby="pills-profile-tab">
                                        <form>
                                            <div class="form-group">
											...
											<div class="form-group mt-1">
												<div class="input-group-append">
													<div class="">
                                                        <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#set-criteria-modal">Set Criteria</a>
													</div>
												</div>
	...
	<!-- Criteria Modal -->
	<div class="modal fade" id="set-criteria-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Set Evaluation Criteria</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				...
				<div class="modal-body" style="background: #fff;">
					<div class="table-responsive">
						<table class="table table-borderless" id="table-criteria">
							<tbody>
								<tr>
									<th>CRITERIA</th>
									<th>BASE MARK</th>
								...
								<tr>
									<td><input id="criteria-0" type="text"  class="form-control req_fields" ></td>
									<td><input id="mark-0" type="number" min="0" max="25"  class="form-control inp-mark req_fields" placeholder="- -"></td>
								</tr>
								<tr>
									<td><input id="criteria-1" type="text"  class="form-control req_fields" ></td>
									<td><input id="mark-1" type="number" min="0" max="25" class="form-control inp-mark req_fields" placeholder="- -"></td>
								</tr>
								<tr>
									<td><input id="criteria-2" type="text"  class="form-control req_fields" ></td>
									<td><input id="mark-2" type="number" min="0" max="25" class="form-control inp-mark req_fields" placeholder="- -"></td>
								</tr>
								<tr>
									<td><input id="criteria-3" type="text"  class="form-control req_fields" ></td>
									<td><input id="mark-3" type="number" min="0" max="25" class="form-control inp-mark req_fields" placeholder="- -"></td>
								</tr>
								<tr>
									<td><input id="criteria-4" type="text"  class="form-control req_fields" ></td>
									<td><input id="mark-4" type="number" min="0" max="25" class="form-control inp-mark req_fields" placeholder="- -"></td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="modal-footer">
					<div class="row">
						<div class="col-md-6">
							<button id="btn-save-criteria" type="button" class="btn btn-warning m-auto" >Save</button>
						</div>
					</div>
				</div>
			</div>

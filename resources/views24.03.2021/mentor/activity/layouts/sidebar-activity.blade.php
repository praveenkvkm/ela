			...
			<div class="sidebar-wrapper scrollbar-inner">
				<div class="sidebar-content">
					...
					<ul class="nav">
						...
						-->
						<li class="nav-item">
							<a id="item-content" href="{{url('admin/add-mentor')}}">
							...
							-->
							<a id="item-media" href="{{url('admin/add-student')}}">
								<i class="fas fa-desktop"></i>
								<p>ADD MEDIA</p>
							</a>
							<a id="item-invite-students" href="{{url('admin/add-activity')}}">
								<i class="fas fa-desktop"></i>
								<p>INVITE STUDENTS</p>
							</a>
							<a id="item-publish" href="{{url('admin/add-activity')}}">
								<i class="fas fa-desktop"></i>
								<p>PUBLISH</p>
							</a>
							<!--

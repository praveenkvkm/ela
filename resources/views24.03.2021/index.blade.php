...
<head>
  ...
  <link rel="icon" href="{{asset('images/favicon/favicon.jpg')}}" type="image/gif" sizes="16x16">
...
<body>
  ...
  <!-- Responsive Navigation Bar -->
	<nav id="header" class="navbar navbar-expand-lg fixed-top navbar-custom">
		<a class="navbar-brand" href="/ela2/login">
			<img class="responsive-image" src="{{asset('images/logo/logo-boers5.png')}}" alt="logo" />
		</a>
    ...
    <div id="carousel-example-2" class="carousel slide carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
          <div class="view">
            <img class="d-block w-100" height="auto" src="{{asset('images/slider/8-3.jpg')}}" alt="First slide">
        ...
        <div class="carousel-item">
          <!--Mask color-->
          <div class="view">
            <img class="d-block w-100" height="auto" src="{{asset('images/slider/2-4.jpg')}}" alt="Second slide">
        ...
        <div class="carousel-item">
          <!--Mask color-->
          <div class="view">
            <img class="d-block w-100" height="auto" src="{{asset('images/slider/4.jpg')}}" alt="Third slide">

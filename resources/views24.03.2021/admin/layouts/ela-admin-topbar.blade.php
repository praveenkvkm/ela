   ...
   <nav class="navbar navbar-expand navbar-white navbar-dark bg-blue">
        <div class="container">
            ...
            <ul class="navbar-nav ml-auto mr-0 mr-md-3 my-2 my-md-0">
                ...
                <li class="nav-item pt-1">
                    <a class="nav-link dropdown-toggle text-dark" href="#"><img src="{{asset('public/ela-assets/images/1.jpg')}}" width="24" /></a>
                </li>
				@else
                ...
                <li class="nav-item dropdown">
					...
					<!--
						...
						<a class="dropdown-item" href="#" data-toggle="modal" data-target="#set-motivation-text">Set Motivation Text</a>

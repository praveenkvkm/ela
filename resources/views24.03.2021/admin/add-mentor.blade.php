						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">ADD MENTOR  <span style="color: blue; font-size:18px; margin-top: 0px; display:none;"  class="card-category text-right " id="p-edit-mode"> - EDIT MODE</span>									
								</div>

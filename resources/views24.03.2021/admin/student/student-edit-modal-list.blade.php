	...
	<div class="modal-dialog modal-lg  modal-dialog-centered">
	  <div class="modal-content">
			<div class="modal-header">
				<div class="row">
					<div class="col-md-7">
                     ...
                     <a id="a-print-single-student" class="dropdown-item" href="{{url('/admin/student/single-student-print')}}">Print</a>
				</div>
					...
					<form class="students-form" style="max-width: 100%;">
						<div class="form-row">
							...
							<div class="col-md-12 text-right">
								<div class="form-check-inline" id="div-active">
								  <label class="form-check-label" for="active" >
									<input type="checkbox" class="form-check-input" id="active" >Active
								  </label>
								</div>
																								
								<a class="btn btn-primary" id="btn-activate">Apply</a>
							</div>
		...
		<!--======================================================== B I O ========================================================================================-->
							...
							<div class="form-group col-md-12 text-right mt-30">
